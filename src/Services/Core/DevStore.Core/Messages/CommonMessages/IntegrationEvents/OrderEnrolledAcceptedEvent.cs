...
namespace DevStore.Core.Messages.CommonMessages.IntegrationEvents
{
    public class OrderEnrolledAcceptedEvent : IntegrationEvent
    {
        ...
        public OrderEnrolledAcceptedEvent(Guid orderId, Guid clientId, decimal total, CoursesOrderDto items, string nameCard, string numberCard, string expirationDateCard, string cvvCard)
        {
            AggregateId = orderId;
            OrderId = orderId;
            ClientId = clientId;
